...
const WORK_PREVIEW = [
  ...
  { title: 'Waterfront',        category: 'Video', thumbnail: thumbWater,  objectPosition: '50% center' },
      ...
      <section ref={ctaRef} data-nav-theme="light" className="section-light relative overflow-hidden py-24 md:py-32">
        ...
        >
          <h2 className="font-display text-[clamp(48px,8vw,120px)] uppercase leading-none text-text-dark">
            Your story<br />
            starts here<span ref={periodRef} className="period-orange period-orange-cta period-pulse" aria-hidden="true" />
          </h2>
